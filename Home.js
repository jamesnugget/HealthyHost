...
<Button onPress={() => this.props.navigation.navigate("Medical Clinics")} style={{backgroundColor: '#DCDCDC', alignSelf:"center", width: '80%', justifyContent: "center", margin: 10, borderRadius: 15}}><Text style={{color: 'black', fontSize: 20}}>{I18n.t('Text.Main_Menu_Choices.3')}</Text></Button>
<Button onPress={() => this.props.navigation.navigate("Resources")} style={{backgroundColor: '#DCDCDC', alignSelf:"center", width: '80%', justifyContent: "center", margin: 10, borderRadius: 15}}><Text style={{color: 'black', fontSize: 20}}>{I18n.t('Text.Main_Menu_Choices.4')}</Text></Button>
<Button onPress={() => this.props.navigation.navigate("Background")} style={{backgroundColor: '#DCDCDC', alignSelf:"center", width: '80%', justifyContent: "center", margin: 10, borderRadius: 15}}><Text style={{color: 'black', fontSize: 20}}>{I18n.t('Text.Main_Menu_Choices.5')}</Text></Button>
<Button onPress={() => this.props.navigation.navigate("Title VI")} style={{backgroundColor: '#DCDCDC', alignSelf:"center", width: '80%', justifyContent: "center", margin: 10, borderRadius: 15}}><Text style={{color: 'black', fontSize: 20}}>{I18n.t('Text.Main_Menu_Choices.6')}</Text></Button>
